...
public class Client {
    ...
    public boolean createTicket(String ticket, int price) throws Exception {
        ...
        TransactionReceipt receipt = token.createTicket(ticket, value).send();
     ...
     * @throws Exception
     */
    public boolean buyTicket(String ticket) throws Exception {
        TransactionReceipt receipt = token.buyTicket(ticket).send();
        return receipt.isStatusOK();
    }
    ...
    public String getTicketInfo(String ticket) throws Exception {
        TransactionReceipt receipt = token.getTicketInfo(ticket).send();
        return "timestamp:owner:price";
    }
}
